...
export const getWorkspacesListener = async (): Promise<InvokeResponse> => {
...
export const createWorkspaceListener = async (event: Electron.IpcMainInvokeEvent, name: string): Promise<InvokeResponse> => {
  const workspaces = await fetchWorkspaces();
